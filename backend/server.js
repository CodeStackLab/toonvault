...
app.get('/api/settings/public', async (req, res) => {
    try {
        const settings = await Setting.find({ key: { $in: ['show_creator_popup', 'site_name', 'maintenance_mode', 'payment_paypal_enabled', 'payment_stripe_enabled', 'free_episode_interval_hrs'] } });
        const config = {};
